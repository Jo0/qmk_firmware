...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  | |-----------------------------------------------------------------------------------------|  ,-----------------.  |------------------  /  | |
  | | CTRL | OS  | ALT  | NO |            SPACE            | NO | ALT | OS  | FN  | CTRL |  |LEFT |DOWN |RIGHT|  |     0     |  .  | HEX | |
  | `-----------------------------------------------------------------------------------------'  `-----------------'  `-----------------------' |
  `---------------------------------------------------------------------------------------------------------------------------------------------' */
  [0] LAYOUT(
    ...
    KC_LCTL,KC_LGUI,KC_LALT,KC_NO,            xxxxxxx,KC_SPC,xxxxxxx,             KC_NO,KC_RALT,KC_RGUI,KC_APP,KC_RCTL,   KC_LEFT,KC_DOWN,KC_RGHT,   KC_P0,          KC_PDOT,KC_PENT),
